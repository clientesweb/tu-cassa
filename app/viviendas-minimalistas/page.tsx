...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/viviendas-minimalistas",
  },
  openGraph: {
    title: "Casas Minimalistas Prefabricadas Tu Cassa | Diseños Modernos y Elegantes",
    description:
...
const minimalistas = [
  ...
  },
  {
    ...
    image: "/images/vivienda-minimalista-2.webp",
  ...
  },
  {
    ...
    image: "/images/vivienda-minimalista-3.webp",
    offerPrice: "$19.380.000",
    bedrooms: "3 dormitorios",
    area: "70m² + 25m² de galería",
    description:
  ...
  },
  {
    ...
    image: "/images/vivienda-minimalista-4.webp",
    offerPrice: "$27.150.000",
                ...
                <CardContent className="p-6 sm:p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button
                      ...
                      asChild
                    >
                      <a href={`/viviendas-minimalistas/${casa.id}`}>Ver detalles</a>
                    </Button>
                    <Button
                      variant="outline"
